...
export const moduleAddress =
  "0xb687713cade5116f731f73cb4c210740ce0849304f0a0dae10a37375b7ffde68";
...
function App() {
  ...
  const fetchList = async () => {
    ...
    try {
      ...
      while (counter <= taskCounter) {
        const tableItem = {
          key_type: "u64",
          value_type: `${moduleAddress}::notion::Task`,
          key: `${counter}`,
        };
  ...
  const onTaskAdded = async () => {
    ...
    const payload = {
      type: "entry_function_payload",
      function: `${moduleAddress}::notion::create_task`,
      type_arguments: [],
      arguments: [newTask],
    };
  ...
  const onCheckboxChange = async (
    ...
    const payload = {
      type: "entry_function_payload",
      function: `${moduleAddress}::notion::complete_task`,
      type_arguments: [],
      arguments: [taskId],
    };
