...
module mint_nft::create_nft {
    ...
    fun init_module(source_account: &signer) {
        let collection_name = string::utf8(b"The Kites");
        let description = string::utf8(b"This is the forst Description Changes");
        let collection_uri = string::utf8(b"Collection uri");
        let token_name = string::utf8(b"Kite");
        let token_uri = string::utf8(b"https://aptogems.xyz");
